...
### **(Em andamento) Udemy - 📚 Curso de Javascript, Angular, React, Vue, Node, HTML, CSS, jQuery, Bootstrap Webpack Gulp MySQL**
...
### **(✔Finalizado) Digital One - 📚 JavaScript Básico**

- [Aulas](/JavaScript/DigitalOne_JavaScript);

### **(✔Finalizado) Digital One - 📚 Curso de EscmaScript 06**
...
### **(✔Finalizado) CFBCursos - 📚 Curso de JavaScript**
...
### **(✔Finalizado) Curso em Vídeo - 📚 Curso de Java e JavaFX**
